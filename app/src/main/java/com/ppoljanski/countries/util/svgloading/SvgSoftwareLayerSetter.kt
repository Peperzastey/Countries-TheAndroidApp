package com.ppoljanski.countries.util.svgloading
...
class SvgSoftwareLayerSetter : RequestListener<PictureDrawable> {
    ...
    override fun onLoadFailed(ex: GlideException?, model: Any, target: Target<PictureDrawable>, isFirstResource: Boolean): Boolean {
